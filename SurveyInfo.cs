...
{
    [Info("Survey Info", "Diesel_42o/Arainrr", "1.0.7", ResourceId = 2463)]
        ...
        private void OnEntityKill(SurveyCharge surveyCharge)
        {
            ...
            timer.Once(0.5f, () =>
            {
                ...
                if (surveyCrater != null)
                {
                    ...
                    Pool.FreeUnmanaged(ref surveyItems);
                }
